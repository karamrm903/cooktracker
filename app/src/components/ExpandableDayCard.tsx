      ...
      >
        <View style={styles.headerRow}>
          <View style={styles.dayNameRow}>
            <Text style={[styles.dayName, { color: TEXT_BROWN }]}>
              {dayName}
            </Text>
            {isToday && (
        ...
        <View style={styles.headerRow}>
          ...
          <Text style={[styles.calDiffText, { color: calDiffColor }]}>
            {calDiffText}
          </Text>
        </View>
      </TouchableOpacity>
      ...
      <View style={styles.macroSummary}>
        ...
        <View style={styles.macroLabelsRow}>
          <View style={styles.macroLabelItem}>
            <View
              style={[styles.dot, { backgroundColor: MACRO_COLORS.protein }]}
            />
            <Text style={[styles.macroLabelName, { color: colors.textMuted }]}>
              Protein{" "}
              <Text style={[styles.macroLabelVal, { color: colors.text }]}>
          ...
          <View style={styles.macroLabelItem}>
            <View
              style={[styles.dot, { backgroundColor: MACRO_COLORS.carbs }]}
            />
            <Text style={[styles.macroLabelName, { color: colors.textMuted }]}>
              Carbs{" "}
              <Text style={[styles.macroLabelVal, { color: colors.text }]}>
              ...
              <View key={meal.id || index}>
                ...
                <View style={styles.mealRow}>
                  <View style={styles.mealLeft}>
                    <Text
                      style={[styles.mealName, { color: TEXT_BROWN }]}
                      numberOfLines={1}
                    >
                    ...
                    <View style={styles.mealMacros}>
                      <Text style={styles.macroText}>
                        <Text style={[styles.macroNum, { color: MACRO_COLORS.protein }]}>
                          {Math.round(meal.protein || 0)}g
                        </Text>
                        <Text style={[styles.macroLabel, { color: MACRO_LABEL_BROWN }]}>
                          {" "}pro
                        </Text>
                      </Text>
                      <Text style={[styles.macroTextDot, { color: colors.textMuted }]}>
                        {" "}·{" "}
                      </Text>
                      <Text style={styles.macroText}>
                        <Text style={[styles.macroNum, { color: MACRO_COLORS.carbs }]}>
                      ...
                      <Text style={styles.macroText}>
                        <Text style={[styles.macroNum, { color: MACRO_COLORS.fat }]}>
                  ...
                  <View style={styles.mealCalContainer}>
                    <Text style={[styles.mealCals, { color: MEAL_KCAL_BROWN }]}>
                      {Math.round(meal.calories || 0)}
                    </Text>
                    <Text style={[styles.mealCalsLabel, { color: "#7F6C64" }]}>
                      kcal
                    </Text>
                  </View>
                </View>
