...
const GOALS = [
  ...
  { key: 'healthy',  label: 'Eat Healthy',       emoji: '🥗' },
];

const ACTIVITIES = [
  { key: 'sedentary', label: 'Sedentary',         emoji: '🛋️' },
  { key: 'light',     label: 'Lightly Active',    emoji: '🚶' },
  { key: 'moderate',  label: 'Moderately Active', emoji: '🏃' },
  { key: 'very',      label: 'Very Active',       emoji: '🏋️' },
];
            ...
            <View style={styles.gridRow}>
              {GOALS.map(g => (
                <TouchableOpacity
                  ...
                  activeOpacity={0.75}
                >
                  <Text style={styles.gridChipEmoji}>{g.emoji}</Text>
            ...
            <View style={styles.gridRow}>
              {ACTIVITIES.map(a => (
                <TouchableOpacity
                  ...
                  activeOpacity={0.75}
                >
                  <Text style={styles.gridChipEmoji}>{a.emoji}</Text>
